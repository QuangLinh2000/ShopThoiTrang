var product = {
    title: 'Đầm tiệc hồng phối sequin D32169',
    trademark: 'Thương Hiệu: NEM',
    productID: '321691492193020636',
    price: 1493000,
    sale: 20,
    available: 5,
    Productsize: [size1 = {size: 'Size 6', status: 'off'}, size1 = {
        size: 'Size 8',
        status: 'on'
    }, size3 = {size: 'Size 10', status: 'on'}]
    ,
    color: [color1 = {idColor: 'rgb(224 181 165)', status: 'on'}],
    material: 'Vải tafta cao cấp',
    ...
    ,
    producBranch: 'NEM LUXURY',
    model: 'Mặc sản phẩm size 2',
...
var product0 = {
    title: 'ÁO PHAO ĐỎ AK66106',
    trademark: 'Thương Hiệu: NEM',
    productID: '661061872034020682',
    price: 799000,
    sale: 50,
    available: 0,
    Productsize: [size1 = {size: 'Size 2', status: 'off'}, size1 = {
        size: 'Size 4',
        status: 'off'
    }, size1 = {size: 'Size 6', status: 'on'}, size1 = {size: 'Size 8', status: 'on'}]
    ,
    color: [color1 = {idColor: '#ff0000', status: 'off'}, color2 = {idColor: 'rgb(51 83 221)', status: 'on'}],
    material: '',
    ...
    ,
    producBranch: ' NEM NEW',
    model: 'Mặc sản phẩm size 2',
    image: ['1.jpg', 'image2', 'image3', 'image4', 'image5']
};
var product1 = {
    title: 'ĐẦM HOA XANH D00869',
    trademark: 'Thương Hiệu: NEM',
    productID: 'Dam-hoa-xanh-D00869',
    price: 1559000,
    sale: 20,
    available: 0,
    Productsize: [size1 = {size: 'Size 6', status: 'off'}, size1 = {size: 'Size 8', status: 'on'}]
    ,
    color: [color1 = {idColor: 'rgb(224 181 165)', status: 'off'}, color2 = {idColor: 'rgb(51 83 221)', status: 'on'}],
    material: 'Vải tafta cao cấp',
    type: 'Đầm tiệc 2 dây dáng ôm, dài qua gối, tone màu đen hồng nhạt, eo đính nơ bản to, kết hợp tà chất liệu voan sequin'
    ,
    match: 'Đi làm, sự kiện, hay đi dạo phố, tạo vẻ trẻ trung nữ tính cho người mặc.'
...
var product2 = {
    title: 'Áo len dài tay AL62326',
    trademark: 'Thương Hiệu: NEM',
    productID: 'AL62326',
    price: 1493000,
    sale: 50,
...
var product3 = {
    title: 'ÁO KHOÁC THIẾT KẾ AK31582',
    trademark: 'Thương Hiệu: NEM',
    productID: 'AK31582',
    price: 2299000,
    sale: 50,
    ...
    Productsize: [size1 = {size: 'Size 6', status: 'off'}, size1 = {size: 'Size 8', status: 'on'}]
    ,
    color: [color1 = {idColor: '#663537', status: 'on'}],
    material: 'vải tổng hợp cao cấp mềm mại, không nhăn bền màu.',
    ...
    ,
    producBranch: 'NEW NEM',
    model: 'Mặc sản phẩm size 2',
    image: ['1.jpg', 'image2', 'image3', 'image4', 'image5']
}
var product4 = {
    title: 'ĐẦM NHUNG ĐỎ D25432',
    trademark: 'Thương Hiệu: NEM',
    productID: 'D25432',
    price: 1892000,
    sale: 84,
    ...
    Productsize: [size1 = {size: 'Size 6', status: 'off'}, size1 = {size: 'Size 8', status: 'on'}]
    ,
    color: [color1 = {idColor: '#f00', status: 'on'}],
    material: ' vải nhung cao cấp',
...
var product5 = {
    title: 'ÁO KHOÁC LEN HỌA TIẾT AK62546',
    trademark: 'Thương Hiệu: NEM',
    productID: 'AK62546',
    price: 1399000,
    sale: 0,
